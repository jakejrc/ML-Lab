...
ML-Lab v3.8.1 — 机器学习可视化实验平台



在 v3.4 基础上新增关联规则挖掘模块（Apriori + FP-Growth）。



页面：学习路径 · 数据工作台 · 特征工程 · 分类实验 · 回归实验 · 聚类实验 · 关联规则 · 代码沙箱 · AI助教
...
# 验证字体配置
print(f'[FONT] after all imports: font.sans-serif={plt.rcParams["font.sans-serif"]}')

import ml_lab.knowledge_graph as kg_module
...
def on_load_custom_data(file_obj, file_path_text, target_col, task_type, test_ratio):
    ...
    elif file_path_text and _os.path.exists(file_path_text):
    ...
    try:
        ...
        ds_name = f"自定义: {_os.path.basename(file_path)}"
...
def on_kg_render():
    """渲染知识图谱3D交互式可视化"""
    try:
        kg_html_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "kg_3d.html")
...
TOP_HTML = """<div class="top-nav"><div class="top-nav-inner">
  ...
  <div class="brand"><div class="brand-icon"><img src="data:image/png;base64," alt="logo"></div><div>
    ...
    <div class="brand-title">ML-Lab v3.8.1</div>
...
# ═══ 页面0: 学习路径 ═══
  ...
  <span style="font-size:11px;color:#64748b;font-weight:600;margin-right:2px;">常用代码片段：</span>
        ...
        def on_nav(page_name):
            ...
            return [gr.update() for _ in PAGE_ORDER]
        ...
        # 保留 nav.change 绑定作为 Radio 事件占位（避免 Radio 被 disabled）
        # 实际切页由客户端 JS 完成
        nav.change(fn=on_nav, inputs=[nav], outputs=[page_kg, page_learning, page_data, page_fe, page_classify, page_regress, page_cluster, page_assoc, page_code, page_ai])
...
if __name__ == "__main__":
    ...
    app.queue(max_size=20).launch(
        ...
        js="""
/* ============================================
   ML-Lab Page Switcher (Client-side JS)
   ============================================ */
(function() {
  ...
  function getCurrentPageId() {
    var checked = document.querySelector('.sidebar-nav input[type="radio"]:checked');
    if (!checked) return null;
    return PAGE_MAP[checked.value] || null;
  }
  ...
  function setupNav() {
    ...
    // 监听 label 点击事件：使用 label.textContent 立即切页
    ...
    // MutationObserver 监控 page-panel 的 style 变化，React 重置时立即重新应用
    var styleObserver = new MutationObserver(function(mutations) {
      var currentPage = window.__currentPage || 'page-kg';
      mutations.forEach(function(m) {
        if (m.attributeName !== 'style') return;
        var el = m.target;
        var id = el.id;
        if (PAGE_IDS.indexOf(id) < 0) return;
        var expected = (id === currentPage) ? 'flex' : 'none';
        if (el.style.getPropertyValue('display') !== expected) {
          el.style.setProperty('display', expected, 'important');
        }
      });
    });
    
    // 初始化所有 page-panel observer
    ...
    // 初始：显示默认页
    switchPage(getCurrentPageId() || 'page-kg');
    initObservers();
    
    // 定时检查是否有新 page-panel 加入（例如 Gradio 动态渲染）
    setInterval(function() {
      var panels = document.querySelectorAll('.page-panel');
      if (panels.length > 0) initObservers();
    }, 1000);
