...
TOP_HTML = """<div class="top-nav"><div class="top-nav-inner">
  ...
  <div class="brand"><div class="brand-icon"><img src="data:image/png;base64," alt="logo"></div><div>
    ...
    <div class="brand-title">ML-Lab v3.7.0</div>
  ...
  <div class="nav-tags">
    ...
    <span class="nav-tag" data-nav="聚类实验">聚类实验</span><span class="nav-tag" data-nav="关联规则">关联规则</span><span class="nav-tag" data-nav="代码沙箱">代码沙箱</span><span class="nav-tag" data-nav="AI助教">AI助教</span>
...
;(function(){
  document.querySelectorAll('.nav-tag[data-nav]').forEach(function(tag){
    ...
    tag.addEventListener('click', function(){
      ...
      if (!targetId) return;
      var allPages = ["page-learning","page-data","page-fe","page-classify","page-regress","page-cluster","page-assoc","page-code","page-ai"];
      
      // 同步触发侧边栏Radio的change事件（确保Gradio后端渲染页面DOM）
      var navTags = document.querySelectorAll('.nav-tag');
      var currentIdx = -1;
      for (var i = 0; i < navTags.length; i++) {
        if (navTags[i].getAttribute('data-nav') === target) {
          currentIdx = i;
          break;
        }
      }
      if (currentIdx >= 0) {
        ...
        if (radios.length > currentIdx) {
          radios[currentIdx].click();
          radios[currentIdx].dispatchEvent(new Event('change', {bubbles: true}));
        }
      }
      // CSS切换（页面已渲染时即刻生效）
      var css = "<style id=\"ml-lab-page-switch\">" +
        ...
        "</style>";
      var oldStyle = document.getElementById('ml-lab-page-switch');
...
def create_app():
  ...
  <span style="font-size:11px;color:#64748b;font-weight:600;margin-right:2px;">常用代码片段：</span>
        ...
        PAGE_ORDER = ["page-learning", "page-data", "page-fe", "page-classify", "page-regress", "page-cluster", "page-assoc", "page-code", "page-ai"]
        ...
        dynamic_css = gr.HTML(value="<style>#page-data,#page-fe,#page-classify,#page-regress,#page-cluster,#page-assoc,#page-code,#page-ai{display:none!important;}#page-learning{display:flex!important;}</style>", elem_id="dynamic-nav-css")

        nav.change(fn=on_nav, inputs=[nav], outputs=[dynamic_css])

        gr.HTML('<div class="footer-bar">ML-Lab v3.7.0 · Python · Scikit-learn · Gradio · 江苏工程职业技术学院 · MIT License</div>')
